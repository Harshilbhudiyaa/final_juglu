// Register.java with full OTP & Supabase flow and detailed logs
...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(v -> {
            ...
            else Toast.makeText(this, "Please fix the errors", Toast.LENGTH_SHORT).show();
        });
    ...
    private void verifyOtp(TextInputEditText[] otpInputs) {
        ...
        JsonArrayRequest req = new JsonArrayRequest(Request.Method.GET,url,null,
            ...
            @Override public Map<String,String> getHeaders(){ return SupabaseClient.getHeaders(); }
        };
        SupabaseClient.addToRequestQueue(this,req);
    }
    ...
    private void saveUserToSupabase() {
        ...
        UsersRepository.registerUser(this,user,new UsersRepository.UserCallback(){
            @Override public void onSuccess(String userId){
                Log.d("REGISTER","User saved ID: "+userId);
                startActivity(new Intent(Register.this,GenderSelectionActivity.class));
                finish();
            }
